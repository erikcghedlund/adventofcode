...
eval([Int], Accum) -> lists:map(fun (X) -> X + Int end, Accum) ++ lists:map(fun (X) -> X * Int end, Accum);
eval([Head | Tail], Accum) -> eval(Tail, lists:map(fun (X) -> X + Head end, Accum) ++ lists:map(fun (X) -> X * Head end, Accum)).
